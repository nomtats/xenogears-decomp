...
- **New tool: `tools/asmdiff.py`** (2026-03-14): CLI diff tool for per-instruction comparison. Usage: `make asmdiff FUNC=<FuncName>` inside Docker (builds + diffs in one step). Auto-discovers files, handles relocations, color-coded output. Foundation for Tier 5 Diff Interpretation Engine.
