...
- **Decompiled (Matched):** 693
- **Remaining (Unmatched):** 1234
- **Overall Completion:** 35.96%
...
| `src/slus_006.64/psyq/libc` | 8 | 4 | 12 | 66.7% |
...
| `src/slus_006.64/psyq/libgpu` | 51 | 15 | 66 | 77.3% |
...
| `ResetGraph` | `libgpu.c` | 6 | 6 | 105 |
| `func_8004463C` | `libgpu.c` | 5 | 2 | 81 |
| `ClearOTagR` | `libgpu.c` | 4 | 1 | 41 |
| `SetDispMask` | `libgpu.c` | 4 | 2 | 44 |
...
| `func_8001E368` | `rendering.c` | 1 | 3 | 31 |
